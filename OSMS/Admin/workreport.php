...
if(isset($_REQUEST['searchsubmit'])){
    ...
    if($result->num_rows>0){
        ...
        echo '<tr>';
        echo '<td>';
        echo '<input type="submit" class="btn btn-danger text-center d-print-none" value="print" onClick="window.print()">';
        echo '</td>';
        echo '</tr>';
        echo '</tbody>';
        echo '</table>';
    }else{
        echo '<div class="alert alert-warning col-sm-6 ml-5 mt-2 role="alert">No Recoard Found !</div>';
    }
}
?>
</div>
